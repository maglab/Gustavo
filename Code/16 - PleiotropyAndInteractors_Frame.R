...
# LOADING FATA 
DirGenArdArcFrm = readRDS("maglab/Gustavo/Data/Generated/General/ARD_ARC_GeneFrame.rds") %>% 
  dplyr::rename(Cod=Code, Ard=ARD_Meaning, Arc=ARC_Meaning, Gen=Gene)

GenAgeHum_Genes = readRDS("maglab/Gustavo/Data/Generated/HAGR/GenAgeHum_Genes.rds")
...
for(i in 1:NtwLen){
  ...
  Pth = paste("maglab/Gustavo/Data/Generated/",QryNtw,"/",sep="")
  
  IndGenArdArcFrm = paste(Pth,"Proximity_and_Distances/","Indirect_Interactors_Long.csv",sep="") %>% read.csv()
