...
MatPhnPhnLst = readRDS("Data/Generated/Specificity_and_coexpression/Coexpression/Coexpression_Matrices_List.rds") 
PhnMeanFrm = readRDS("Data/Generated/Specificity_and_coexpression/Coexpression/Self_Coexpression_Mean_Frame.rds")
...
PhnPhnScrFrm = readRDS("Data/Generated/Specificity_and_coexpression/Coexpression/Coexpression_Pairwise_Frame.rds") %>%
...
# LOT
BoxPhnScrFrm$Lbl = "Intra-Set Coexpression in genes associated with ARCs and GenAge"
...
p = ggpar(p, xlab ="ARC and GenAge sets", ylab = "Intra-Set Coexpression", legend.title = "") +
...
write.table(BoxPhnScrFrm,'Data/Generated/Specificity_and_coexpression/Coexpression/BoxPlot_Data.csv', row.names = FALSE, sep=",")
...
Htm = Heatmap(as.matrix(PltFrm), name = "Mean Coexpression",
              column_title = "Column Gen-set (ARC, GenAge and ARC-Pleiotropy)", 
              row_title = "Row Gen-set (ARC, GenAge and ARC-Pleiotropy)",
              column_title_gp = gpar(fontsize = 11),  # Adjust fontsize as needed
              row_title_gp = gpar(fontsize = 11),     # Adjust fontsize as needed
...
write.table(PltFrm,'Data/Generated/Specificity_and_coexpression/Coexpression/Heatmap_Data.csv', row.names = FALSE, sep=",")
...
TopAnn = HeatmapAnnotation(
  ...
  Intra_set_coexpression = anno_simple(PhnMeanFrm$Mean, 
...
FntSiz = 8
TxtDeg = 60
Htm = Heatmap(as.matrix(PltFrm), name = "Differential Itra-set Coexpression\nbetween Gene-sets:\nColumn.Set − Row.Set", 
              column_title = "Column Gene-set (ARCs, GenAge and ARC-Pleiotropy)", 
              row_title = "Row Gene-set (ARCs, GenAge and ARC-Pleiotropy)",
  ...
  Heatmap(PhnMeanFrm$Mean,
          ...
          name = "Intra-set Coexpression (Mean)",
