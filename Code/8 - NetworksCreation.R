...
GenPhnFrm = readRDS("maglab/Gustavo/Data/Generated/General/ARD_GenAge_GeneFrame.rds") %>%
...
for(i in 1:NtwLen){
  ...
  if(NtwQry == "PPI"){
    ...
    EdgFrm = read.csv("maglab/Gustavo/Data/Retrieved/Networks/BIOGRID-MV-Physical-4.4.204.tab3.txt", sep="\t") # 04/12 - 164MB
  ...
  if(NtwQry == "COX90"){
    ...
    EdgFrm = read.table("maglab/Gustavo/Data/Generated/Networks_Creation/Coexpression/MatrixCox90_Ensembl.csv")
    EdgFrm = EdgFrm %>% dplyr::filter(row!=col)
    
    OrgEnsNam = readRDS("maglab/Gustavo/Data/Generated/Networks_Creation/Coexpression/GenesCox90.rds")
  ...
  if(NtwQry == "COX95"){
    ...
    EdgFrm = read.table("maglab/Gustavo/Data/Generated/Networks_Creation/Coexpression/MatrixCox95_Ensembl.csv")
    EdgFrm = EdgFrm %>% dplyr::filter(row!=col)
    
    OrgEnsNam = readRDS("maglab/Gustavo/Data/Generated/Networks_Creation/Coexpression/GenesCox95.rds")
  ...
  if(NtwQry == "KEGG"){
    ...
    EdgFrm = readRDS("maglab/Gustavo/Data/Generated/Networks_Creation/KEGG/Other/KEGG_Interactions.rds") 
  ...
  saveRDS(Nod,paste("maglab/Gustavo/Data/Generated/",NtwQry,"/Lists/NodesList.rds", sep=''))
  saveRDS(Edg,paste("maglab/Gustavo/Data/Generated/",NtwQry,"/Lists/EdgesList.rds", sep=''))
  saveRDS(Grp,paste("maglab/Gustavo/Data/Generated/",NtwQry,"/Lists/GraphsList.rds", sep=''))
