...
DisCat = read.csv("maglab/Gustavo/Data/Retrieved/Showcase/Ukb_DiseaseHierarchy.csv")
...
write.csv(HrcFrm, "maglab/Gustavo/Data/Generated/Showcase/Ukb_DiseaseRoots.csv")
