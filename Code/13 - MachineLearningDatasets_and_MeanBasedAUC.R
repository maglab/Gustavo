...
AgeGenAll = readRDS("maglab/Gustavo/Data/Generated/HAGR/GenAgeHum_Genes.rds")
...
for(NtwQry in NtwArr){
  ...
  Nod = paste("maglab/Gustavo/Data/Generated/",NtwQry,"/Lists/NodesList.rds", sep='') %>% readRDS()
...
AucFrm$Gene = NULL
write.csv(AucFrm, "maglab/Gustavo/Data/Generated/Ageing_Prediction_Performances/Mean_Based_AUC.csv" )
