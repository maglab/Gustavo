...
AgeingHumans = read.csv('maglab/Gustavo/Data/Retrieved/HAGR/genage_human.csv')
AgeingHumans$symbol %>% unique() %>% saveRDS('maglab/Gustavo/Data/Generated/HAGR/GenAgeMod_Genes.rds')
...
Oma_Mouse = read.csv('maglab/Gustavo/Data/Retrieved/OMA/OMA_Mouse.csv')
Oma_Fly = read.csv('maglab/Gustavo/Data/Retrieved/OMA/OMA_Fly.csv')
Oma_Worm = read.csv('maglab/Gustavo/Data/Retrieved/OMA/OMA_Worm.csv')
Oma_Yeast = read.csv('maglab/Gustavo/Data/Retrieved/OMA/OMA_Yeast.csv')

# AGEING AND DIETARY RESTRICTION
AgeingModels = read.csv('maglab/Gustavo/Data/Retrieved/HAGR/genage_models.csv')
...
saveRDS(ModelAgeingGenes, "maglab/Gustavo/Data/Generated/HAGR/GenAgeMod_Genes.rds")
