...
AgePhnHrc_Frm = read.csv("maglab/Gustavo/Data/Generated/Showcase/Ukb_DiseaseRoots.csv")
...
for(x in 1:NtwLen){
  print(x)
  NtwQry = NtwArr[x]
  TxtPth = paste("maglab/Gustavo/Data/Generated/",NtwQry,"/",sep="")
  ...
  # DRAW HEATMAP
  HtmLst[[NtwQry]] = draw(Htm, padding = unit(c(-10, 2, 1.5, 1), "mm")) 
...
write.csv(ArcPrx_ArcInt_Frm,"maglab/Gustavo/Data/Generated/Proximity_and_Interactors/Proximity_and_Interactors.csv",row.names=FALSE)
saveRDS(HtmLst,"maglab/Gustavo/Data/Generated/Proximity_and_Interactor/ARC_Distance_Heatmaps_List.rds")
