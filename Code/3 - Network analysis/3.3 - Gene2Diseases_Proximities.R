...
for(x in 1:NtwLen){
  ...
  GenGen_DstFrm = paste("Data/Generated/Networks_and_predictions/Networks/",QryNtw,"/Proximity_and_Distances/","GenGen_DistanceFrame.rds",sep="") %>% readRDS()
  GenGen_PrxFrm = paste("Data/Generated/Networks_and_predictions/Networks/",QryNtw,"/Proximity_and_Distances/","GenGen_ProximityFrame.rds",sep="") %>% readRDS()
  ...
  saveRDS(GenArd_PrxDstLst, paste("Data/Generated/Networks_and_predictions/Networks/",QryNtw,"/Proximity_and_Distances/","Proximities_To_ARC_ARD.rds", sep="") )
