...
GenArcAgeFrm = readRDS('maglab/Gustavo/Data/Generated/General/ARD_GenAge_GeneFrame.rds') %>%
  dplyr::rename(Cod=Code, Gen=Gene)
GenAgeHumArr = readRDS("maglab/Gustavo/Data/Generated/HAGR/GenAgeHum_Genes.rds")
GenAgeModArr = readRDS("maglab/Gustavo/Data/Generated/HAGR/GenAgeMod_Genes.rds")
...
ArdHrcFrm = read.csv("maglab/Gustavo/Data/Generated/Showcase/Ukb_DiseaseRoots.csv") %>%
